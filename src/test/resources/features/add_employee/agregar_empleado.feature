...
Característica: Agregar empleado
  ...
  Escenario: Agregar empleado con datos básicos
    ...
    Y busca el empleado por nombre "Omar" e id "123654"
    Entonces verifica que el empleado aparece en la tabla con id "123654", nombre "Omar Eduardo" y apellido "Rincon"
